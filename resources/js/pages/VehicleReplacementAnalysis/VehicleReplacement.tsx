    ...
    try {
      ...
      if (response.data?.status) {
        ...
        setFormData({
          ...
          estimatedVehicleLife: String(replacement.estimated_vehicle_life || ''),
          ...
          serviceCostEstimates: replacement.service_cost_estimates || {
            year1: '1500',
            year2: '1500',
            year3: '1500',
            year4: '300',
          ...
          fuelCostEstimates: replacement.fuel_cost_estimates || {
            year1: { value: '1.5'},
            year2: { value: '1.6' },
            year3: { value: '1.75' },
            year4: { value: '1.9' },
