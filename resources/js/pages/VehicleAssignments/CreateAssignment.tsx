            ...
            <div className="mt-4">
                ...
                <div>
                    ...
                    <input
                        ...
                        required
                        className={`h-11 w-full rounded-lg border bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 ${
                        errors.eventTitle ? "border-red-500" : "border-gray-300 focus:border-brand-300"
                        }`}
                    />
                    {errors.eventTitle && (
                ...
                <div className="mt-3 grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <select
                        ...
                        required
                        className={`h-11 w-full rounded-lg border bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 ${
                        errors.vehicleId ? "border-red-500" : "border-gray-300 focus:border-brand-300"
                        }`}
                    ...
                    {(() => {
                      ...
                      return (
                        <select
                          ...
                          required
                          className={`h-11 w-full rounded-lg border bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 ${
                            errors.contactId ? "border-red-500" : "border-gray-300 focus:border-brand-300"
                ...
                <div>
                    ...
                    <input
                        ...
                        className={`h-11 w-full appearance-none rounded-lg border bg-transparent bg-none px-4 py-2.5 pl-4 pr-11 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 ${
                        errors.eventEndTime ? "border-red-500" : "border-gray-300 focus:border-brand-300"
                        }`}
                    />
                    </div>
                    {errors.eventEndTime && (
