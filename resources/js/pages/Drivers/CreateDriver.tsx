        ...
        <div className="space-y-6">
            <div className="flex flex-col items-center">
                {profilePicturePreview ? (
                    ...
                    <div
                        {...getProfileRootProps()}
                        className={`w-48 h-48 rounded-full border-2 border-dashed flex items-center justify-center cursor-pointer transition ${isProfileDragActive
    ...
    const renderLicenseSection = () => (
        <div className="space-y-6">
            ...
            <div>
                ...
                <div
                    {...getLicenseRootProps()}
                    className={`border border-dashed rounded-xl p-7 cursor-pointer transition ${isLicenseDragActive
        ...
        <div className="space-y-6">
            ...
            <div>
                ...
                <div
                    ...
                    className={`border border-dashed rounded-xl p-7 cursor-pointer transition ${isOfferLetterDragActive
                            ? "border-brand-500 bg-gray-100 dark:bg-gray-800"
                            : "border-gray-300 bg-gray-50 dark:border-gray-700 dark:bg-gray-900"
                        }`}
                >
                                ...
                                {sidebarItems.map((item) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`w-full flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-lg transition-colors relative ${activeSection === item.key
                                                    ? hasError
