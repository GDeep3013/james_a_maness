...
export default function EditVehicle() {
    ...
    return (
        <>
            {/* <PageMeta title="Edit Vehicle" description="Edit vehicle details" /> */}
            <PageMeta
                title={isEditMode ? "Edit Vehicle" : "Create New Vehicle"}
                description={isEditMode ? "Edit vehicle details" : "Create a new Vehicle"}
            />
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <h1 className="text-2xl font-semibold text-gray-800 dark:text-white/90">
                            {isEditMode ? "Edit Vehicle" : "New Vehicle Entry"}
                        </h1>
                    </div>
                </div>
                            ...
                            {addVehicleSteps.map((step, index) => (
                                <React.Fragment key={step.number}>
                                    <div className="flex flex-col items-center flex-1">
                                        <div
                                            className={`w-10 h-10 p-3 rounded-full flex items-center justify-center font-semibold text-sm transition-colors ${currentStep > step.number
                                    ...
                                    {index < addVehicleSteps.length - 1 && (
                                        <div
                                            className={`flex-1 h-0.5 mx-4 mt-[-20px] ${currentStep > step.number
                                                    ? 'bg-[#00A63E]'
                                                    : 'bg-gray-200'
                                                }`}
                                        />
