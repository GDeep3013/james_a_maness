        ...
        try {
            ...
            const data = response.data as { 
                ...
                data?: {
                    ...
                    vendor_id?: number;
                    warranty_period_months?: string | undefined;
            ...
            if (data.status && data.data) {
                ...
                setFormData({
                    ...
                    unit_price: part.unit_price ? parseFloat(String(part.unit_price)) : 0,
                    purchase_price: part.purchase_price ? parseFloat(String(part.purchase_price)) : 0,
                    vendor_id: part.vendor_id ? part.vendor_id : 0,
                    warranty_period_months: part.warranty_period_months ? part.warranty_period_months : "",
                    status: part.status || "Active" as "Active" | "Inactive",
                });
            } else {
