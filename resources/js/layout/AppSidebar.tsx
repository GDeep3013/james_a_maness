...
const AppSidebar: React.FC = () => {
  ...
  return (
    <aside
      className={`kav-side-bar-bg fixed mt-16 flex flex-col lg:mt-0 top-0 px-0 left-0 dark:bg-gray-900 dark:border-gray-800 text-gray-900 h-screen transition-all duration-300 ease-in-out z-50
        ${
    ...
    >
      <div
        className={`py-3 px-4 flex bg-white mt-5 ${
