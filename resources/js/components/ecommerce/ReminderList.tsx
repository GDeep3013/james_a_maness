...
export default function ReminderList() {
    ...
    const getDashboardReminders = async () => {
        ...
        setError("");
        try {
            const response = await serviceReminderService.getAllReminder();
    ...
    // Helper function to calculate priority based on days until due
        ...
        <div className="rounded-2xl border border-gray-200 bg-white px-5 pb-5 pt-5 dark:border-gray-800 dark:bg-white/[0.03] sm:px-6 sm:pt-6 min-h-[140px] h-full">
            ...
            <header className="flex justify-between items-center mb-6 border-b pb-4">
                ...
                <button
                    ...
                    className="flex items-center space-x-1 px-2 md:px-4 py-2 text-black font-medium rounded-lg hover:bg-gray-50 transition duration-150 border border-gray-300 text-sm md:text-base"
                >
